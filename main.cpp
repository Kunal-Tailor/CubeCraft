...
// CubeScanner with OpenCV - Webcam-based Rubik's Cube Solver -----------------------------------------------
    ...
    cout << "============================================\n\n";
    cout << "Instructions:\n";
    cout << "  1. Hold each face of the cube in front of your webcam\n";
    cout << "  2. Align it within the grid overlay\n";
    cout << "  3. Press SPACE to capture the face\n";
    cout << "  4. Press N to accept and move to next face, or R to rescan\n";
    cout << "  5. Scan all 6 faces: UP, LEFT, FRONT, RIGHT, BACK, DOWN\n\n";
    ...
    cout << "\nSolving with IDA* + Corner Pattern Database...\n\n";

    IDAstarSolver<RubiksCubeBitboard, HashBitboard> idAstarSolver(cube, fileName);
    auto solve_moves = idAstarSolver.solve();

    cout << "Solution (" << solve_moves.size() << " moves): ";
    for (auto move: solve_moves) cout << cube.getMove(move) << " ";
    cout << "\n\n";

    cout << "Solved cube:\n";
    idAstarSolver.rubiksCube.print();
    cout << (idAstarSolver.rubiksCube.isSolved() ? "✅ SOLVED!\n" : "❌ NOT SOLVED\n");
